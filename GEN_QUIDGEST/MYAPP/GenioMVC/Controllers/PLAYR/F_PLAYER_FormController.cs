...
// USE /[MANUAL AJF AFTER_CANCEL F_PLAYER]/
		...
		public class F_player_CntryValCountryModel : RequestLookupModel
		{
			public F_player_ViewModel Model { get; set; }
		}

		//
		// GET: /Playr/F_player_CntryValCountry
		// POST: /Playr/F_player_CntryValCountry
		[ActionName("F_player_CntryValCountry")]
		public ActionResult F_player_CntryValCountry([FromBody] F_player_CntryValCountryModel requestModel)
		{
			...
			F_player_CntryValCountry_ViewModel model = new(UserContext.Current, parentCtx);
