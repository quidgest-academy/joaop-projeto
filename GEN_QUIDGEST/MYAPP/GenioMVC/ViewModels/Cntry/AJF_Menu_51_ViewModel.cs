...
{
	public class AJF_Menu_51_ViewModel : MenuListViewModel<Models.Cntry>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<AJF_Menu_51_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "2d3ec8ba-0d2c-464a-9196-94cf8cf35bc7";
...
// USE /[MANUAL AJF LIST_LIMITS 51]/
		...
		public override int GetCount(User user)
		{
			...
			var areaBase = CSGenio.business.Area.createArea("cntry", user, "AJF");
			...
			ListingMVC<CSGenioAcntry> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public AJF_Menu_51_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="AJF_Menu_51_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public AJF_Menu_51_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public AJF_Menu_51_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<AJF_Menu_51_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Cntry.AddEPH<CSGenioAcntry>(ref u, crs, "ML51");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Cntry.AddEPH<CSGenioAcntry>(ref u, null, "ML51"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcntry> Qlisting, ref CriteriaSet conditions)
		{
			...
			}, "ms", "Time to load the menu."))
			{
				...
				CriteriaSet ajf_menu_51Conds = CriteriaSet.And();
				...
				conditions.SubSets.Add(ajf_menu_51Conds);
				ajf_menu_51Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
				tableReload &= hasAllRequiredLimits;

// USE /[MANUAL AJF OVERRQ 51]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcntry>(m_userContext, false, ajf_menu_51Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML51", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL AJF OVERRQLSTEXP 51]/
...
// USE /[MANUAL AJF OVERRQLIST 51]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcntry.GetInformation(), QMVC_POS_RECORD, sorts, ajf_menu_51Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAcntry> listing = Models.ModelBase.Where<CSGenioAcntry>(m_userContext, distinct, ajf_menu_51Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML51", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapAJF_Menu_51(listing);
		...
		private List<AJF_Menu_51_RowViewModel> MapAJF_Menu_51(ListingMVC<CSGenioAcntry> Qlisting)
		{
			List<AJF_Menu_51_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapAJF_Menu_51(row));
					i++;
				}
			}
		...
		/// to a AJF_Menu_51_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private AJF_Menu_51_RowViewModel MapAJF_Menu_51(CSGenioAcntry row)
		{
			var model = new AJF_Menu_51_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL AJF VIEWMODEL_CUSTOM AJF_MENU_51]/
