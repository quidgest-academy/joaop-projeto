...
public class AJF_Menu_41_RowViewModel : Models.Club
{
	#region Constructors

	public AJF_Menu_41_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public AJF_Menu_41_RowViewModel(UserContext userContext, CSGenioAclub val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
