...
public class F_cntrct_PlayrValName_RowViewModel : Models.Playr
{
	#region Constructors

	public F_cntrct_PlayrValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_cntrct_PlayrValName_RowViewModel(UserContext userContext, CSGenioAplayr val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
