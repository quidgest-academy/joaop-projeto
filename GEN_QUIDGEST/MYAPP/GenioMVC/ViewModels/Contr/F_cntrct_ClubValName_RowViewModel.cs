...
public class F_cntrct_ClubValName_RowViewModel : Models.Club
{
	#region Constructors

	public F_cntrct_ClubValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_cntrct_ClubValName_RowViewModel(UserContext userContext, CSGenioAclub val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
