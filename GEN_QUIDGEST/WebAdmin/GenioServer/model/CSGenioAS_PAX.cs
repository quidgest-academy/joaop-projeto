...
namespace CSGenio.business
{
	...
	public class CSGenioAs_pax : DbArea
	{
		...
		public CSGenioAs_pax(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL AJF CONSTRUTOR S_PAX]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			Qfield.Dupmsg = "";
			info.RegisterFieldDB(Qfield);
			Qfield = new Field(info.Alias, "documentfk", FieldType.KEY_VARCHAR);
			Qfield.FieldSize = 8;
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("s_apr", new Relation("AJF", "asyncprocessattachments", "s_pax", "codpranx", "cods_apr", "AJF", "asyncprocess", "s_apr", "codascpr", "codascpr"));
		}
