...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("AJF", "userauthorization", "userauthorization", "codua", "codpsw", "AJF", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL AJF TABAUX UserAuthorization]/
