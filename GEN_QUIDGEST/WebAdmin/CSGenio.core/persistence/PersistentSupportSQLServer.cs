    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("AJFMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("AJFMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("AJFMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("AJFMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("AJFMQQueues_History", "ANO", "ANO")
                            .Select("AJFMQQueues_History", "USERNAME", "USERNAME")
                            .Select("AJFMQQueues_History", "TABELA", "TABELA")
                            .Select("AJFMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("AJFMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("AJFMQQueues_History", "QUEUE", "QUEUE")
                            .Select("AJFMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("AJFMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("AJFMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("AJFMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("AJFMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("AJFMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("AJFMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("AJFMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("AJFMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.AJFMQQueues_History";
