...
SET @SQL = N'
CREATE DATABASE [ASPStateAJF]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateAJF'', FILENAME = N''' + @SQLDataFolder + 'ASPStateAJF.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateAJF_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateAJF_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateAJF_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateAJF_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateAJF_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateAJF] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateAJF] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
